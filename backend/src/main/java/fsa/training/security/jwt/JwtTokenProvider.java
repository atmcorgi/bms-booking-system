package fsa.training.security.jwt;
...
public class JwtTokenProvider implements TokenProvider {
    ...
    public Map<String, Object> getPayload(String token) {
        try{
            ...
            if(jwt.getIssuer() != null) result.put("issuer", jwt.getIssuer());
            if(jwt.getIssuedAt() != null) result.put("issuedAt", jwt.getIssuedAt());
            if(jwt.getExpiresAt() != null) result.put("expiresAt", jwt.getExpiresAt());
            if(jwt.getSubject() != null) result.put("subject", jwt.getSubject());
            if(jwt.getId() != null) result.put("id", jwt.getId());
            if(jwt.getAudience() != null && !jwt.getAudience().isEmpty()) result.put("audience", jwt.getAudience());
            ...
            for(var entry : claims.entrySet()) {
                ...
                if(asBoolean != null) value = asBoolean;
                else {
